        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <form method="post" action="{{ url('/ligas/crear') }}">
                    @csrf
                    <div class="form-group">
                      <label for="nombre">Nombre</label>
                      <input class="form-control @error('nombre') is-invalid @enderror" type="text" value="{{ old('nombre') }}" id="nombre" name="nombre" placeholder="Nombre de la liga"/>
                      @error('nombre')
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control @error('descripcion') is-invalid @enderror" value="" id="descripcion" name="descripcion" placeholder="Explica a los jugadores las reglas a aplicar durante la liga"></textarea>
                      @error('descripcion')
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control @error('maximopresupuesto') is-invalid @enderror" type="number" value="" id="maximopresupuesto" name="maximopresupuesto" placeholder="Máximo presupuesto inicial de los equipos que se apuntan"/>
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control @error('numgrupos') is-invalid @enderror" type="number" value="" id="numgrupos" name="numgrupos" placeholder="Grupos que conformarán la liga"/>
                      @error('numgrupos')
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <input class="form-control @error('liganovatos') is-invalid @enderror" type="checkbox" @if(old('liganovatos')) checked="checked" @endif value="1" id="liganovatos" name="liganovatos"/>
                      @error('liganovatos')
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <input class="form-control @error('cruzargrupos') is-invalid @enderror" type="checkbox" @if(old('cruzargrupos')) checked="checked" @endif value="1" id="cruzargrupos" name="cruzargrupos"/>
                      @error('cruzargrupos')
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <input class="form-control @error('idavueltagrupo') is-invalid @enderror" type="checkbox" @if(old('idavueltagrupo')) checked="checked" @endif value="1" id="idavueltagrupo" name="idavueltagrupo"/>
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <input class="form-control @error('idavueltatodos') is-invalid @enderror" type="checkbox" @if(old('idavueltatodos')) checked="checked" @endif value="1" id="idavueltatodos" name="idavueltatodos"/>
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <input class="form-control @error('jornadadescanso') is-invalid @enderror" type="checkbox" @if(old('jornadadescanso')) checked="checked" @endif value="1" id="jornadadescanso" name="jornadadescanso"/>
                    ...
                    <div class="form-group col-md-4 float-left">
                      ...
                      <input class="form-control @error('puntosvictoria') is-invalid @enderror" type="number" value="" id="puntosvictoria" name="puntosvictoria" />
                    ...
                    <div class="form-group col-md-4 float-left">
                      ...
                      <input class="form-control @error('puntosempate') is-invalid @enderror" type="number" value="" id="puntosempate" name="puntosempate" />
                      @error('puntosempate')
                    ...
                    <div class="form-group col-md-4 float-left">
                      ...
                      <input class="form-control @error('puntosderrota') is-invalid @enderror" type="number" value="" id="puntosderrota" name="puntosderrota" />
                      @error('puntosderrota')
